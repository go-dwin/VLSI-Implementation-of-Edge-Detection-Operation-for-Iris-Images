...
module subsystem_tb (
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(10),
    .inputFile("grayscale_subsystem_gateway_in.dat"),
    .periodMultiplier(1)
  )
  gateway_in_driver (
    .clk(clk_net),
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(10),
    .inputFile("grayscale_subsystem_gateway_in1.dat"),
    .periodMultiplier(1)
  )
  gateway_in1_driver (
    .clk(clk_net),
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(10),
    .inputFile("grayscale_subsystem_gateway_in2.dat"),
    .periodMultiplier(1)
  )
  gateway_in2_driver (
    .clk(clk_net),
  ...
  xltbsink #(
    ...
    .i_bin_pt(12),
    .i_width(24),
    .inputFile("grayscale_subsystem_gateway_out.dat"),
    .periodMultiplier(1)
  )
  gateway_out_load (
    .i(gateway_out_net),
  ...
  Subsystem_bd_wrapper sysgen_dut (
